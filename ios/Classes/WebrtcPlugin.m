...
+ (void)registerWithRegistrar:(NSObject<FlutterPluginRegistrar>*)registrar {
  FlutterMethodChannel* channel = [FlutterMethodChannel
      methodChannelWithName:@"webrtc"
            binaryMessenger:[registrar messenger]];
  UIViewController *viewController = (UIViewController *)registrar.messenger;

  WebrtcPlugin* instance = [[WebrtcPlugin alloc] initWithChannel:channel
                                                      registrar:registrar
...
- (void)handleMethodCall:(FlutterMethodCall*)call result:(FlutterResult)result {
  ...
  if ([@"getPlatformVersion" isEqualToString:call.method]) {
    ...
    result(@"Logged Successfully!");
      ...
      eventChannelWithName:[NSString stringWithFormat:@"webrtc/peerConnectoinEvent%@", peerConnectionId]
